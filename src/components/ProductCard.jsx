...
const ProductCard = ({ title, category, description, features, images, image, lang = 'Hindi' }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white/95 border border-slate-200 hover:border-[#0284C7]/60 rounded-3xl overflow-hidden shadow-xl shadow-slate-900/5 hover:shadow-2xl hover:shadow-[#0284C7]/15 flex flex-col justify-between group backdrop-blur-xl relative transition-all duration-300 h-full"
    >
      ...
      <div className="relative z-10 flex flex-col flex-grow">
        ...
        <div className="p-6 flex flex-col flex-grow justify-between space-y-4">
          ...
          <div className="space-y-2 pt-4 border-t border-slate-100 transition-colors duration-300 mt-auto">
      ...
      <div className="p-5 relative z-10 bg-slate-50/80 border-t border-slate-100 transition-colors duration-300 shrink-0">
        <motion.a
